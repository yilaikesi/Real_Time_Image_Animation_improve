...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_image", default='Inputs/Monalisa.png', help="path to source image")
    parser.add_argument("--driving_video", default='1.mp4', help="path to driving video")
